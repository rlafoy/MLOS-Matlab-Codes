function pranaPIV3D_parallel_code_runner_02;
...
top_write_directory='/home/aether/mnt/drive2/Vortex_Ring_Tomo/Circulation_Testing/Vortex_Ring_014741_Particles/Reconstruction/Full_Reconstruction/';
...
% This is the number of frames to step to the correlation frame (ie setting
% this equal to 1 correlates the n and n+1 frames).
frame_corr_step=1;

% This creates the data structure for processing
Data=generate_data_structure;

% This rewrites the value of 'Data.imcstep' to change the correlation step
% size
Data.imcstep=num2str(frame_corr_step);
...
Data.imdirec                    = '/home/aether/mnt/drive2/Vortex_Ring_Tomo/Circulation_Testing/Vortex_Ring_014741_Particles/Reconstruction/Full_Reconstruction';
Data.maskdirec                  = '/home/aether/mnt/drive2/Vortex_Ring_Tomo/Circulation_Testing/Vortex_Ring_014741_Particles/Reconstruction/Full_Reconstruction';
Data.outdirec                   = '/home/aether/mnt/drive2/Vortex_Ring_Tomo/Circulation_Testing/Vortex_Ring_014741_Particles/Reconstruction/Full_Reconstruction';
...
%% PIV1
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Data.PIV1.winres                    = '64,64,64'; % Effective resolution
Data.PIV1.winsize                   = '128,128,128'; % Actual resoltuion
Data.PIV1.winauto                   = '1';
Data.PIV1.gridres                   = '32,32,32';%'32,32,32'; % Distance between windows in voxels
Data.PIV1.winoverlap                = '50,50,50';
...
%% PIV2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Data.PIV2.winres                    = '32,32,32';
Data.PIV2.winsize                   = '64,64,64';
Data.PIV2.winauto                   = '1';
Data.PIV2.gridres                   = '16,16,16';
Data.PIV2.winoverlap                = '50,50,50';
...
%% PIV3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Data.PIV3.winres                    = '16,16,16';
Data.PIV3.winsize                   = '32,32,32';
Data.PIV3.winauto                   = '1';
Data.PIV3.gridres                   = '8,8,8';
Data.PIV3.winoverlap                = '50,50,50';
